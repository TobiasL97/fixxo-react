    ...
    <div className="product-view">
        ...
        <div className="product-detail">
            ...
            <div className="share-socialmedia">
                ...
                <NavLink className="share-socialmedia-links"><i class="fa-brands fa-facebook-f"></i></NavLink>
                <NavLink className="share-socialmedia-links"><i class="fa-brands fa-instagram"></i></NavLink>
                <NavLink className="share-socialmedia-links"><i class="fa-brands fa-twitter"></i></NavLink>
                <NavLink className="share-socialmedia-links"><i class="fa-brands fa-google"></i></NavLink>
                <NavLink className="share-socialmedia-links"><i class="fa-brands fa-linkedin"></i></NavLink>
            </div>
        </div>
    </div>
  )
